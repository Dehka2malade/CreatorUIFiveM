...
RegisterServerEvent("Creator:save", function(firstName, lastName, dateOfBirth, sexe, height)
    ...
    if (playerSelected.get("first_connection") == true) then
        playerSelected.showNotification("~b~Bienvenue sur Astra\nSi vous avez la moindre question n'hésitez pas à nous contacter sur notre discord: https://discord.gg/Astra")
    end
